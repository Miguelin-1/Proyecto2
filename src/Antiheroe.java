...
public class Antiheroe extends Personaje {
    ...
    public Antiheroe(int edad, String nombre, String nacionalidad, String genero, String altura, ArrayList<String> papeles, ArrayList<String> premios, String nombre_personaje, String alias_personaje, ArrayList<String> poderes, ArrayList<String> debilidades, ArrayList<String> dichos, String motivacion,int nivelAmenaza) {
