...
public class Personaje extends Persona {
    ...
    public Personaje(String nombre, String alias_personaje, ArrayList<String> poderes, ArrayList<String> debilidades, ArrayList<String> dichos,String nombre_personaje) {
